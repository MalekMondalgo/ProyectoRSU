<?php
$pagina_actual = 'segundoentregable';
?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 d-flex align-items-center mb-3">
                    <div class="mx-auto">
                        <img src="../../../assets/images/logos/PasoEjecucion2.png" alt="">
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-2">REGISTRAR TU SEGUNDO AVANCE</h5>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <a href="tercerentregable.php" class="btn btn-primary btn-lg">REGISTRAR</a>
                                    </div>
                                </div>
