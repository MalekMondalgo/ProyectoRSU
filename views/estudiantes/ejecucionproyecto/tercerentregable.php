<?php
$pagina_actual = 'tercerentregable';
?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 d-flex align-items-center mb-3">
                    <div class="mx-auto">
                        <img src="../../../assets/images/logos/PasoEjecucion3.png" alt="">
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-2">REGISTRAR TU TERCER AVANCE</h5>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <a href="ejecucionproyecto.php" class="btn btn-primary btn-lg">REGISTRAR</a>
